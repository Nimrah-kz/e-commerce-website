  ...
  <div className="container px-5 pb-16 mx-auto">
    <div className="flex flex-wrap -m-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        {/* 6 */}
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        <Link href={"/Khaadi"} className="block relative h-48 hover:scale-105 hover:duration-300 rounded overflow-hidden">
          <Image alt='Khaadi' src={img6}/>
        </Link>
        <div className="mt-4">
          <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">
            CATEGORY
      ...
      <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
        ...
        <div className="mt-4">
          ...
          <p className="mt-1">Discover the perfect blend of comfort and style with RungJa collection. Fashion-forward, affordable, and always on trend!</p>
        </div>
      </div>
    </div>
  </div>
