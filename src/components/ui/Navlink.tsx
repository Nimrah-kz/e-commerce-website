...
const components: { title: string; href: string; description: string }[] = [
  ...
  },
  {
    ...
    href: "/Khaadi",
    description:
      "Khaadi is a renowned fashion brand offering elegant and chic designs, blending traditional craftsmanship with modern flair for timeless, sophisticated style.",
  },
  {
    title: "Sana-Safinaz",
    href: "/Sana-Safinaz",
  ...
  },
  {
    ...
    href: "/RungJa",
    description:
      "RungJa is a contemporary fashion brand offering stylish, sophisticated, and versatile clothing with a perfect blend of modern cuts and traditional elegance.",
  },
];
